# Nginx Proxy Manager Monitor (NPM Monitor)
...
3. 增新 Dashboard
    1. 進入 `Dashboards` ，點擊 `New` - `Import`
        ...
        ![CleanShot_2025-02-22_at_19.56.022x](https://cdn.rxchi1d.me/inktrace/nginx-proxy-manager-monitor_20250426_02-image.png)
...
4. 按需求調整 labelFilter 與 regexFilter
    ...
    ![CleanShot_2025-02-25_at_15.24.33](https://cdn.rxchi1d.me/inktrace/nginx-proxy-manager-monitor_20250426_04-image.png)

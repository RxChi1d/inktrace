...
- **Previous Works and Challenges**
    ...
    ![Figure 1](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127358939_figure-1.png "Figure 1")
...
![Figure 2](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127361861_figure-2.png "Figure 2")
...
![Figure 3](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127370667_figure-3.png "Figure 3")
...
![Figure 4](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127374086_figure-4.png "Figure 4")
...
![Table 1: Comparison with state-of-the-art methods on Shiny Blender Dataset. Except for Ref-NeRF and PhySG, whose results are taken from the original paper of Ref-NeRF, we implemented the released code on Shiny Blender dataset for other methods. IDR failed to recover meaningful geometry for helmet and toaster, so the results remain empty. Note that NeRF-W failed to produce meshes since it focuses on novel view synthesis in the wild, and COLMAP generated meshes with severe artifacts and missing parts. The quantitative results were not provided. **Bold** results have the best score and underlined the second best. Our method outperforms these methods by a large margin.](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127382436_table-1.png "Table 1: Comparison with state-of-the-art methods on Shiny Blender Dataset. Except for Ref-NeRF and PhySG, whose results are taken from the original paper of Ref-NeRF, we implemented the released code on Shiny Blender dataset for other methods. IDR failed to recover meaningful geometry for helmet and toaster, so the results remain empty. Note that NeRF-W failed to produce meshes since it focuses on novel view synthesis in the wild, and COLMAP generated meshes with severe artifacts and missing parts. The quantitative results were not provided. **Bold** results have the best score and underlined the second best. Our method outperforms these methods by a large margin.")

![Table 2](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127383693_table-2.png "Table 2")
...
![Figure 1. Our ambiguity-reduced framework significantly improves explicit surfaces geometry, surface normals and rendering realism for modeling reflective surfaces compared to NeuS and Ref-NeRF. Reconstruction accuracy (lower is better), surface normal mean angular error, i.e., MAE (lower is better) and PSNR (higher is better) are compared.](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127358939_figure-1.png "Figure 1. Our ambiguity-reduced framework significantly improves explicit surfaces geometry, surface normals and rendering realism for modeling reflective surfaces compared to NeuS and Ref-NeRF. Reconstruction accuracy (lower is better), surface normal mean angular error, i.e., MAE (lower is better) and PSNR (higher is better) are compared.")

![Figure 5. The geometry of reconstructed meshes and estimated surface normals on Shiny Blender dataset [43]. We ran NeuS, Geo-Neus and Ref-NeRF official implementations. Our method obviously produces better geometry and surface normals than other methods.](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127378323_figure-5.png "Figure 5. The geometry of reconstructed meshes and estimated surface normals on Shiny Blender dataset [43]. We ran NeuS, Geo-Neus and Ref-NeRF official implementations. Our method obviously produces better geometry and surface normals than other methods.")

從 Fig.1 與 Fig.5 都可以看出本篇的方法在幾何精度與表面法線的預測都有明顯的改進。

![Table 3. Rendering quality comparison on Shiny Blender dataset. PSNR is adopted as evluation metric.](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127393178_table-3.png "Table 3. Rendering quality comparison on Shiny Blender dataset. PSNR is adopted as evluation metric.")
...
![Table 4](https://images.rxchi1d.me/file/inktrace/paper-survey/Ref-NeuS/1789127393483_table-4.png "Table 4")
